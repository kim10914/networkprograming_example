 ...
 * 파일 클래스
 */
public class ChatMessageS_9_5 extends JFrame {
    ...
    public static void main(String args[]) {
        ChatMessageS_9_5 s = new ChatMessageS_9_5();
        s.runServer();
    }
...
//        String serverdata = "";
        ChatMessageS_9_5 cs; // 파일 클래스를 선언하는 객체
         ...
         * 서버 쓰레드 생성자
         */
        public ServerThread(ChatMessageS_9_5 c, Socket s, JTextArea ta, JLabel l) {
            sock = s;
            display = ta;
            info = l;
            cs = c;
