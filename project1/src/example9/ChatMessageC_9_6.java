...
public class ChatMessageC_9_6 extends JFrame implements ActionListener, KeyListener {
    ...
    public ChatMessageC_9_6() {
        ...
        addWindowListener(new ChatMessageC_9_6.WinListener());
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            output.flush();
            ltext.setVisible(false); // 안보이게 설정
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void main(String args[]) {
        ChatMessageC_9_6 c = new ChatMessageC_9_6();
        c.runClient();
    }
